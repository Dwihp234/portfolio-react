  ...
  return (
    <section id="skills" className="skills-section">
      <div className="container">
            ...
            <div key={index} className="skill-category">
              ...
              <div className="skills-list">
                {category.skills.map((skill, skillIndex) => (
                  <div key={skillIndex} className="skill-item compact">
                    <span className="skill-icon compact">{skill.icon}</span>
                    <span className="skill-name compact">{skill.name}</span>
                    <span className="skill-percentage compact">{skill.level}%</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="tech-skills-stats compact">
